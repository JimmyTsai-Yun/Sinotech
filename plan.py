...
class Sheetpile_plan(Base_plan):
    ...
    def extract_data(self, annotation_img_lists, wall_img_lists):
        ...
        for i, ann_img in enumerate(annotation_img_lists):
            ...
            ann_text_info = self.ocr_tool.extract_text(ann_guassian_img)
    ...
    def run(self):
        annotation_img_lists = pdf_to_images(self.annotation_pdf_path, dpi=210, output_folder="./", drawing_type="sheet_pile_plan_ann")
        wall_img_lists = pdf_to_images(self.wall_pdf_path, dpi=210, output_folder="./", drawing_type="sheet_pile_plan_wall")
